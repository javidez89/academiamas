...
El curso Project Management Essentials es una adaptación educativa en español basada en el PDF Project Management Essentials.pdf aportado por el usuario, que contiene la PM2 Project Management Methodology Guide 3.1 de la Comisión Europea, documento reutilizable bajo CC BY 4.0 con atribución. No se incluye el PDF fuente en el repositorio.

El curso Scrum Fundamentals es una adaptación educativa en español basada en el PDF Scrum Fundamentals.pdf aportado por el usuario. No se incluye el PDF fuente en el repositorio.
